...
//			saveInstructorWithCourses(instructorDao);

//			fetchInstructorWithCourses(instructorDao);

//			fetchCourseByInstructorId(instructorDao);

//			fetchInstructorJoinFetch(instructorDao);
